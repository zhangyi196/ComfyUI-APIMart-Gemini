...
class GPTImage2OfficialGenerationNode:
    ...
    def INPUT_TYPES(cls) -> Dict[str, Any]:
        return {
            "required": {
                ...
                "model": (["gpt-image-2-official"], {"default": "gpt-image-2-official"}),
                "n": (["1", "2", "3", "4"], {"default": "1"}),
                "size": (
    ...
    def tensor_to_base64(self, tensor: Any, image_format: str = "PNG") -> str:
    ...
    def generate(
        ...
        **kwargs: Any,
        ...
        try:
            print(f"[GPTImage2OfficialNode] 开始生成，模式: {mode}")
            ...
            print(f"[GPTImage2OfficialNode] 提交请求: {self.API_URL}")
...
NODE_CLASS_MAPPINGS = {
    "GPTImage2OfficialGenerationNode": GPTImage2OfficialGenerationNode,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "GPTImage2OfficialGenerationNode": "GPT Image 2 Official (APImart)",
}
